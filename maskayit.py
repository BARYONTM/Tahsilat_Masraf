...
class KayitlarWindow(QDialog):
    ...
    def load_kayitlar(self):
        ...
        with open('masraf_kayitlar.csv', 'r') as file:
    ...
    def delete_kayit(self):
        ...
        if len(selected_rows) > 0:
            confirm = QMessageBox.question(self, 'Sil', 'Seçili kayıtları silmek istiyor musunuz?',
    ...
    def save_kayitlar(self):
        with open('masraf_kayitlar.csv', 'w', newline='') as file:
